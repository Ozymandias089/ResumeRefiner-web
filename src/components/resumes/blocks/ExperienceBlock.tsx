...
export function ExperienceBlock(props: {
    ...
    onChangeItemAction: (idx: number, patch: Partial<ResumeExperienceForm>) => void;
}) {
    const { experiences, disabled, onAddAction, onRemoveAction, onChangeItemAction } = props;
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            <div className="space-y-2">
                                ...
                                <Input
                                    disabled={disabled}
                                    value={x.company??""}
                                    onChange={(e) => onChangeItemAction(idx, { company: e.target.value })}
                                />
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    disabled={disabled}
                                    value={x.role??""}
                                    onChange={(e) => onChangeItemAction(idx, { role: e.target.value })}
                                />
                            </div>
                            ...
                            <div className="space-y-2 md:col-span-2">
                                ...
                                <Input
                                    disabled={disabled}
                                    value={x.period??""}
                                    onChange={(e) => onChangeItemAction(idx, { period: e.target.value })}
                            ...
                            <div className="space-y-2 md:col-span-2">
                                ...
                                <Textarea
                                    disabled={disabled}
                                    value={x.description??""}
                                    onChange={(e) => onChangeItemAction(idx, { description: e.target.value })}
                                />
                            </div>
                        </div>
                    </div>
